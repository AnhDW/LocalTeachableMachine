...
@Component({
  ...
  template: `
    <div class="min-h-screen flex flex-col bg-gray-50 text-gray-800 font-sans">
      <header class="bg-white shadow-sm border-b border-gray-200 px-4 md:px-6 py-4 flex flex-wrap items-center justify-between gap-4 sticky top-0 z-50">
        <div class="flex items-center gap-2 md:gap-4">
          ...
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base md:text-xl font-medium text-gray-700 truncate">Image Project</h1>
          </div>
        </div>
      ...
      <main class="flex-1 w-full p-4 md:p-6 flex flex-col lg:grid lg:grid-cols-12 gap-4 md:gap-6 overflow-y-auto lg:overflow-hidden">
